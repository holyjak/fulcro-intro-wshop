...
2. Click the _Pick Element_ in the top left corner and then click "Item 1" in the webapp
  * Note: The element tab is showing a _snapshot_ of the Fulcro component data how it was at the time when you picked it
...
5. In `ui.cljs`, under _Exercise 3.5_, execute the form `(binding ...)` and explore the output in Shadow Inspect (no _Pretty-Print_ available :()
 ...
 * _Transactions_ show side-effects executed in the frontend, i.e. data loads and other Fulcro mutations
