...
(You might want to refer back to the link:./INTRO.md[INTRO.md] so keep it open somewhere.)
...
| https://github.com/holyjak/fulcro-intro-wshop/blob/main/docs/Exercises.adoc[Exercises] tab | 
...
4. Read the https://github.com/holyjak/fulcro-intro-wshop/blob/5412e1117d498bfa91241a1c16fe9cc25b72c996/src/fulcro_todomvc/api.cljs#L47[frontend Fulcro defmutation] code.
...
5. Read the https://github.com/holyjak/fulcro-intro-wshop/blob/5412e1117d498bfa91241a1c16fe9cc25b72c996/src/fulcro_todomvc/server.clj#L37[backend Pathom defmutation] code
